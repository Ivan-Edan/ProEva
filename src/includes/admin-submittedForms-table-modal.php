...
<div class="modal fade" id="form1Modal" tabindex="-1" aria-labelledby="form1ModalLabel" aria-hidden="true">
    ...
    <input type="hidden" id="form1Type" value="form1" />
    <div class="modal-dialog modal-xl">
        <div class="modal-content" id="form1ModalContent">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button type="button" id="rejectForm1" class="btn btn-danger mx-2"  style="border-radius: 25px;">Reject</button>
                <button type="button" id="acceptForm1" class="btn btn-success mx-2" style="border-radius: 25px;">Accept</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="form2Modal" tabindex="-1" aria-labelledby="form2ModalLabel" aria-hidden="true">
    ...
    <input type="hidden" id="form2Type" value="form2" />
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="form2ModalContent">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button type="button" id="rejectForm2" class="btn btn-danger mx-2"  style="border-radius: 25px;">Reject</button>
                <button type="button" id="acceptForm2" class="btn btn-success mx-2" style="border-radius: 25px;">Accept</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="form3Modal" tabindex="-1" aria-labelledby="form3ModalLabel" aria-hidden="true">
    ...
    <input type="hidden" id="form3Type" value="form3" />
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="form3ModalContent">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button type="button" id="rejectForm3" class="btn btn-danger mx-2"  style="border-radius: 25px;">Reject</button>
                <button type="button" id="acceptForm3" class="btn btn-success mx-2" style="border-radius: 25px;">Accept</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="form4Modal" tabindex="-1" aria-labelledby="form4ModalLabel" aria-hidden="true">
    ...
    <input type="hidden" id="form4Type" value="form4" />
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="form4ModalContent">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button type="button" id="rejectForm4" class="btn btn-danger mx-2"  style="border-radius: 25px;">Reject</button>
                <button type="button" id="acceptForm4" class="btn btn-success mx-2" style="border-radius: 25px;">Accept</button>
            </div>
        </div>
    </div>
</div>
